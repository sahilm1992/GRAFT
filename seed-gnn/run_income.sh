...
rm -rf ~/data/seed_gnn_data/edit_ckpts_feature_ablated/income/no_fnlwgt/income/*
...
# models=("gcn")
# models=("gcn")
# datasets=("pokec" "income")
datasets=("income")

# --- FEATURE ABLATION CONFIGURATION ---
USE_FEATURE_ABLATION=true # Set to true to enable
FEATURE_VARIANT="no_fnlwgt"
